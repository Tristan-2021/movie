...
import 'package:movi/src/feature/movi/cubit/cubit/cubit/cubitmovie_cubit.dart';
import 'package:movi/src/feature/movi/cubit/cubit/cubit/cubitmovie_state.dart';
                          ...
                          Padding(
                            ...
                            child: CircleAvatar(
                              backgroundImage: NetworkImage(
                                  getPosterImg(state.cast![i].profilePath)),
                              radius: 30.0,
                            ),
                          ),
                          SizedBox(
